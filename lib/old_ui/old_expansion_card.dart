...
class OldExpansionCard extends StatefulWidget {
  ...
  OldExpansionCard(this.scaffoldKey, this.vessel, this.onEdit, this.onTap,
      this.onDelete, this.isSingleView);

  @override
  State<OldExpansionCard> createState() => _OldExpansionCardState();
}

class _OldExpansionCardState extends State<OldExpansionCard> {

                ...
                Row(
                  ...
                  children: [
                    ...
                    widget.tripList?.tripStatus == 0
                      ...
                      context: context,
                      text:
                      '${DateFormat('yyyy-MM-dd hh:mm').format(DateTime.parse(widget.tripList!.createdAt!))}  ${widget.tripList?.updatedAt != null ? '-${DateFormat('MM/dd/yyyy hh:mm').format(DateTime.parse(widget.tripList!.updatedAt!))}' : ''}',
                      fontWeight: FontWeight.w500,
                      textColor: Colors.black,
                      textSize: displayWidth(context) * 0.018,
                    ),
                ...
                widget.tripList?.tripStatus != 0
                  ...
                  children: [
                    SizedBox(
                        ...
                        child: CommonButtons.getOldRichTextActionButton(
                  ...
                  children: [
                    Expanded(
                      child: SizedBox(
                          height: displayHeight(context) * 0.038,
                          child:
                          CommonButtons.getOldRichTextActionButton(
                              buttonPrimaryColor: buttonBGColor,
                              fontSize:

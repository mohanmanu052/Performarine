...
class CommonDropDownFormFieldOne extends FormField<dynamic> {
        ...
        child: InputDecorator(
          ...
          child: DropdownButtonFormField<String>(
            ...
            decoration: InputDecoration(
              ...
              contentPadding: EdgeInsets.only(left: displayWidth(context) * 0.07,right: displayWidth(context) * 0.45),

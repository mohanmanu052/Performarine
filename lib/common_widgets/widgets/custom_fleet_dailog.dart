...
class CustomFleetDailog {
  ...
  void showEditFleetDialog(
      {List<FleetData>? fleetData,
      BuildContext? context,
      bool isDropDownEnabled = true,
      FleetData? selectedFleetValue,
      Function(List<String>)? onUpdateChange,
      }) async {
                              ...
                              onChanged: isDropDownEnabled
                                  ? (newValue) {
                                      setState(() {
                                        ...
                                        debugPrint("SELECTED VALUE ${newValue!.id}");
                                      });
                                    }
                                  : null,
                            ),

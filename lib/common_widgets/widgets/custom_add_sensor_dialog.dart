...
class CustomAddSensorDialog extends StatelessWidget {
  Function()? positiveBtnOnTap;

  bool isPositiveBtnClick = false, isNegativeBtnClick = false;
  bool? userConfig = false, isError = false;

  List<String> sensorsList = ['Shaft RPM', 'Strain', 'RPM',];
  String dropdownValue = 'Shaft RPM';
                                ...
                                items: sensorsList.map((item) {
                                  return DropdownMenuItem<String>(
                                    ...
                                    child:  commonText(
                                        text: item ?? '',
                                        context: context,
                                        textSize:orientation==Orientation.portrait? displayWidth(context) * 0.04:displayWidth(context) * 0.030,
                                        textColor: Theme.of(context).brightness == Brightness.dark
                                            ? Colors.white
                                            : Colors.black,

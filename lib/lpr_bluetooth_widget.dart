...
import 'bluetooth_support_widgets.dart';
...
class _LprBluetoothWidgetState extends State<LprBluetoothWidget> {
  ...
  bool updateLprTime(){
    ...
    String date =  "D${timeNow.month.toString().padLeft(2, '0')}/${timeNow.day.toString().padLeft(2, '0')}/${timeNow.year}";
    String time = "T${timeNow.hour.toString().padLeft(2, '0')}:${timeNow.minute.toString().padLeft(2, '0')}:${timeNow.second.toString().padLeft(2, '0')}";

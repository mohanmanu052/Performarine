                    ...
                    if (check) {
                      ...
                      } else
                      {
                        try {
                         ...
                         // String? firstName = user.displayName == null ? ' ' : user.displayName?.split(' ').first == null ? ' ' : user.displayName?.split(' ').first;
                         // String? lastName = user.displayName == null ? ' ' : user.displayName?.split(' ').last == null ?  ' ' : user.displayName?.split(' ').last;

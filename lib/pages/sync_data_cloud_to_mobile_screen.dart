    ...
    commonProvider
      ...
      Utils.customPrint('RRRRR 12 VESSEL DATA: ${value.vessels![i].toJson()}');
            ...
            CreateVessel vesselData = CreateVessel(
                ...
                fuelCapacity: double.parse(value.vessels![i].fuelCapacity.toString()),
                batteryCapacity: double.parse(value.vessels![i].batteryCapacity.toString()),
                ...
                vesselSize: double.parse(value.vessels![i].vesselSize.toString()),

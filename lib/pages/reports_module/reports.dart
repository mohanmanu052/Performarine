...
// Calculate the total minutes
    ...
    return double.parse('$totalMinutes.${seconds.toInt()}');
      ...
      debugPrint("INTERNET CONNECTION RESULT ${result}");
          switch(result)
          {
            ...
            case ConnectivityResult.mobile:
              if(await Utils().check(scaffoldKey))
                {
                                ...
                                isVesselDataLoading!
                                    ? InkWell(
                                        onTap: () async {
                                          ...
                                          bool dialogCode = await Utils().check(scaffoldKey, showDialogBox: false);
          ...
          child: SizedBox(
              width: durationColumnSeriesData.length > 3
                  ? orientation == Orientation.portrait
                      ...
                      : (1.5 * 110 * durationColumnSeriesData.length)
                  : displayWidth(context),
              height: graph_height,
